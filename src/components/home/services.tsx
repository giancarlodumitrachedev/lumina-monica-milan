...
const services = [
  { title: "Terapia Sistemico-Familiare", description: "Un percorso per l'intero nucleo familiare, volto a ripristinare dinamiche relazionali sane.", icon: <UserCircle className="w-8 h-8" /> },
  { title: "Terapia di Coppia", description: "Sostegno per ritrovare comunicazione, intimità e comprensione reciproca nei momenti di crisi.", icon: <Users className="w-8 h-8" /> },
  { title: "Sostegno Individuale", description: "Un luogo di collaborazione dove terapeuta e persona co-costruiscono il percorso passo dopo passo.", icon: <Activity className="w-8 h-8" /> }
];
